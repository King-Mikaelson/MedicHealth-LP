...
function NavBar() {
  ...
  <nav className='shadow-md w-full fixed top-0 left-0 z-10'>
    <div className='md:flex flex items-center  justify-between  bg-white py-4 xl:px-40 lg:px-24  md:mx-0  relative'>
   ...
   <XMarkIcon  onClick={() => {setOpen(prevValue => !prevValue)}} className="block h-10 w-6" aria-hidden="true"/>
    ...
    <div className="flex items-center ">
                ...
                <button
                  type="button"
                  className='bg-[#191BFB] py-3 px-5 flex justify-center items-center rounded-[100px]'
                >
